...
export const styles = sortCx({
    ...
    colors: {
        primary: {
            root: [
                "bg-coffee-brown text-cream-white shadow-xs-skeuomorphic ring-1 ring-coffee-brown ring-inset hover:bg-coffee-brown/80 hover:ring-coffee-brown/80 data-loading:bg-coffee-brown/80",
        ...
        secondary: {
            root: [
                "bg-cream-white text-coffee-brown shadow-xs-skeuomorphic ring-1 ring-coffee-brown ring-inset hover:bg-coffee-brown/10 hover:ring-coffee-brown/80 data-loading:bg-coffee-brown/10",
                // Icon styles
                "*:data-icon:text-coffee-brown/60 hover:*:data-icon:text-coffee-brown/80",
            ].join(" "),
        },
        tertiary: {
            root: [
